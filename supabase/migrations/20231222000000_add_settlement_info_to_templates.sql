-- Add settlement_info column to host_quote_templates table for storing host bank account information
-- This is used when payment_method is 'online' to store country-specific settlement details

ALTER TABLE host_quote_templates
ADD COLUMN IF NOT EXISTS settlement_info jsonb;

-- Add comment to describe the column
COMMENT ON COLUMN host_quote_templates.settlement_info IS 'Host bank account information for settlements. Structure varies by country:
