...
function MigrationBanner({ onClick, country }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="migration-banner-icon" style={{ color: 'white' }}>
        ...
        <div className="migration-banner-text" style={{ flex: 1 }}>
          <h3 style={{ fontSize: '18px', fontWeight: '600', color: 'white', margin: '0 0 4px 0' }}>
            {t(country, 'migrationBannerTitle')}
          </h3>
          <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.9)', margin: 0 }}>
            {t(country, 'migrationBannerDesc')}
          </p>
        </div>
        <div className="migration-banner-arrow" style={{ color: 'white' }}>
